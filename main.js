    ...
    function getCity() {
     ...
     var city_2 = document.getElementById("city").value;
    console.log(city_2);
    ...
    fetch(coords)
        ...
        .then(resp => {
            ...
            document.getElementById("icon_sun").src = "http://openweathermap.org/img/w/"+weather_descriptionIcon+".png";
             ...
             document.getElementById("data").textContent = "Dzień: " + currentDate.getDate() + "." + (currentDate.getMonth()+1) + "." + currentDate.getFullYear();;
              ;})
